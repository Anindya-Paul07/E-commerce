...
export async function create(req, res, next) {
  try {
    const { title, description, price, images = [], brand, status = 'active', stock = 0, tags = [], slug } = req.body || {};
    ...
    const product = await Product.create({ title, slug: finalSlug, description, price, images, brand, status, stock, tags });
